// import Product from `@${process.env.NEXT_PUBLIC_HOST}//models/Product`;
    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          ...
          <h2 className='font-bold mt-3'>Product Description:</h2>
        </div>
        ...
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          <div className="flex">
            ...
            {(product.category=="tshirt" || product.category == "hoodies")&&
        ...
        {product.availableQty>0 &&<span className="title-font font-medium text-2xl text-gray-900">₹{product.price}</span>}
          ...
          <button onClick={()=>{buyNow(slug, 1,product.price,product.title,size,color)}} disabled={product.availableQty<=0?true : false} className="flex ml-4 px-2 text-white disabled:bg-yellow-300 bg-yellow-500 border-0 py-2 md:px-6 focus:outline-none hover:bg-yellow-600 rounded">Buy Now</button>
          <button onClick={()=>{addToCart(slug, 1,product.price,product.title,size,color)}} disabled={product.availableQty<=0?true : false} className="flex ml-4 px-2 text-white disabled:bg-yellow-300 bg-yellow-500 border-0 py-2 md:px-6 focus:outline-none hover:bg-yellow-600 rounded">Add To Cart</button>
        ...
        <div className="pin mt-6 flex space-x-2 text-md">
          <input onChange={onChangePin} placeholder='Enter your Pincode' className='px-2 border-2 rounded-md border-gray-400' type="number" />
          <button onClick={checkServiceability} className='text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded'>Check</button>
        </div>
