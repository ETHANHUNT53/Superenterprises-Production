...
const Mugs = ({products}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    {Object.keys(products).map((item)=>{
      ...
      <div className="w-full lg:mx-5 md:1/2 p-4  cursor-pointer mx-auto shadow-lg m-5">
        ...
        <div className="mt-4 text-center md:text-left">
          ...
          <h2 className="text-gray-900 title-font text-lg w-[350px] font-medium">{products[item].title}</h2>
          ...
          <div className="mt-1">
          {products[item].color.includes('grey') && <button className="border-2 border-gray-300 ml-1 bg-gray-700 rounded-full w-6 h-6 focus:outline-none"></button>}
